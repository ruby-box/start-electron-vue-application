...
export default class NpApplication {
  constructor() { }

  static start() {
    app.on('ready', () => {
      //트레이 아이콘 만들기
      //tray = NpMain.npTray.createTray()

      //Window 컨텍스트 메뉴 초기화
      NpMain.npWindowContextMenu.registWindowContextMenu()
    ...
    // app.on('web-contents-created', (session) => {
