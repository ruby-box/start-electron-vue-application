...
export default function parseCommandLine (processArgs) {
  ...
  if (args.uriHandler) {
    args = {
      uriHandler: true,
      'uri-handler': true,
      _: args._.filter(str => str.startsWith('netprotect://')).slice(0, 1)
    }
  }
  ...
  if (args.version) {
    process.stdout.write(
      `NetProtectAgent    : ${app.getVersion()}\n` +
